      ...
      >
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-12 min-w-0 w-full md:max-w-[520px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Full Name */}
            <div>
              <label htmlFor="signup-fullname" className="block text-sm font-semibold font-sans mb-1.5" style={{ color: '#0F172A' }}>
                Full Name
              </label>
            ...
            {/* Email */}
            <div>
              <label htmlFor="signup-email" className="block text-sm font-semibold font-sans mb-1.5" style={{ color: '#0F172A' }}>
                Email
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div>
              <label htmlFor="signup-password" className="block text-sm font-semibold font-sans mb-1.5" style={{ color: '#0F172A' }}>
                Password
              </label>
              <div className="relative">
            ...
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3.5 font-bold text-sm font-sans rounded-full transition-all duration-200 mt-1"
              style={{
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { id: 'signup-apple', label: 'Apple', icon: <AppleIcon /> },
              { id: 'signup-google', label: 'Google', icon: <GoogleIcon /> },
              { id: 'signup-meta', label: 'Meta', icon: <MetaIcon /> },
            ].map(({ id, label, icon }) => (
              <button
                key={id}
                id={id}
          ...
          {/* Footer line */}
          <p className="text-center text-sm font-sans mt-5" style={{ color: '#6B7280' }}>
        ...
        >
          <Image
            ...
            alt="European university campus — study abroad with edunex"
            fill
          ...
          >
            ...
            <p className="font-sans text-xs" style={{ color: '#4B5563' }}>
              Universities, visas, blocked accounts — all in one place
            </p>
          </div>
        </div>
      </div>
